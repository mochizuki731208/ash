...
/*---------------------------------------------------------------------*/
	...
	if(csgs2[0] != ''){
		//tmpStr = '<a id="sanjibtn_'+csgs2[0]+'" class="sanjibtn" target="_blank">选择产品分类</a>';
		//$("#sanji").html(tmpStr);
		//$("#sanjibtn_"+csgs2[0]).colorbox({width:"50%", inline:true, href:"#sanji_list_"+csgs2[0]});
		/*$("#sanji_list_"+csgs2[0]+" li").click(function(){
			var selected=$(this).attr("title");
			$("#sanji_tj").val(selected);
			$("#cboxClose").click();
		});*/
	}else{
		//$("#sanji").html('');
...
/*------------------*/
	...
	//$('#csdq_num').val(csnum);
	if(qygs[0] != ''){
		//tmpStr = '<a id="sanjibtn_'+qygs[0]+'" class="sanjibtn" target="_blank">选择产品分类</a>';
		//$("#sanji").html(tmpStr);
		//$("#sanjibtn_"+qygs[0]).colorbox({width:"50%", inline:true, href:"#sanji_list_"+qygs[0]});
		/*$("#sanji_list_"+qygs[0]+" li").click(function(){
			var selected=$(this).attr("title");
			$("#sanji_tj").val(selected);
			$("#cboxClose").click();
		});*/
