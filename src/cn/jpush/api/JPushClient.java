...
public class JPushClient {
	...
	public static final String MASTRSECRET = "9904f73535abdadb56c93f8e";
	public static final String APPKEY = "546b0f30a36850ec48cdd155";
	 ...
	 */
	public JPushClient() {
	    _pushClient = new PushClient(MASTRSECRET, APPKEY);
	    _reportClient = new ReportClient(MASTRSECRET, APPKEY);
	    _deviceClient = new DeviceClient(MASTRSECRET, APPKEY);
	}
