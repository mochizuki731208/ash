package com.easemob.server.jersey.api;
...
//        }
	...
	public static ObjectNode createNewIMUserSingle(ObjectNode dataNode) {
		...
		if (null != dataNode && !dataNode.has("username")) {
			System.out.println("Property that named username must be provided .");
		...
		if (null != dataNode && !dataNode.has("password")) {
			System.out.println("Property that named password must be provided .");
	...
	public static ObjectNode getIMUsersByUserName(String userName) {
		...
		if (StringUtils.isEmpty(userName)) {
			System.out.println("The primaryKey that will be useed to query must be provided .");
	...
	public static ObjectNode modifyIMUserPasswordWithAdminToken(
		...
		if (StringUtils.isEmpty(userName)) {
			System.out.println("Property that named userName must be provided，the value is username or uuid of imuser.");
	...
	public static ObjectNode addFriendSingle(String ownerUserName,
		...
		if (StringUtils.isEmpty(ownerUserName)) {
			System.out.println("Your userName must be provided，the value is username or uuid of imuser.");
		...
		if (StringUtils.isEmpty(friendUserName)) {
			System.out.println("The userName of friend must be provided，the value is username or uuid of imuser.");
	...
	public static ObjectNode imUserLogin(String ownerUserName, String password) {
		...
		if (StringUtils.isEmpty(password)) {
			System.out.println("Your password must be provided，the value is username or uuid of imuser.");
